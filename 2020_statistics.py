...
json_2017 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/standings_2017.json'
response = requests.get(json_2017)
data = response.json()
...
# Load the data from your JSON file
json_2018 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/standings_2018.json'
response = requests.get(json_2018)
data = response.json()
import pandas as pd
...
# Load the data from your JSON file
json_2020 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/fixtures_2020.json'
response = requests.get(json_2020)
data = response.json()
...
dfs1 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2020standings(36).csv') 
dfs2 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2020points(36).csv')
...
app.layout = html.Div(
    [
        html.H1(
            'Team Performance Dashboard (2020-2021 Season)',
...
if __name__ == '__main__':
    app.run_server(debug=True, port=8046, use_reloader=False)

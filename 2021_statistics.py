...
json_2021 = 'https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/fixtures_2021.json'
response = requests.get(json_2021)
data = response.json()
...
dfs1 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2021standings(38).csv') 
dfs2 = pd.read_csv('https://raw.githubusercontent.com/gjoshi22/GoalWise_Laliga-Data-Visualization/main/DV-Project-main/DV-Project-main/project/2021points(38).csv')
...
if __name__ == '__main__':
    app.run_server(debug=True, port=8047, use_reloader=False)
